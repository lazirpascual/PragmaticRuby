...
module StudioGame
  ...
  def test_sorted_players_by_decreasing_health
    @game.add_player(@player_1)
    @game.add_player(@player_2)

    assert_equal [@player_2, @player_1], @game.sorted_players
  end
  ...
  def test_play_adds_treasures_to_players
    ...
    assert_empty @player_1.found_treasures
    assert_empty @player_2.found_treasures

    @game.play(1)

    refute_empty @player_1.found_treasures
    refute_empty @player_2.found_treasures
  end
end
